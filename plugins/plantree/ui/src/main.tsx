...
import { createHttpPromptFileCopier, createHttpToolCaller } from "./http-tool-caller";
...
async function bootstrap(): Promise<void> {
  ...
  try {
    ...
    root.render(<PlanTreeWindow plan={snapshot} toolCaller={createHttpToolCaller("")} promptFileCopier={createHttpPromptFileCopier("")} webMode />);
  } catch {
